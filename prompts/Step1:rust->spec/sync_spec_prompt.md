...
## 任务
为 crate `sync` 生成 OpenSpec capability specs。
...
1. 创建 `openspec/specs/sync/spec.md`，包含：
   - 使用 SHALL/MUST 规范化措辞
...
2. 如果 crate 有明显架构/unsafe 约束/feature matrix，创建 `openspec/specs/sync/design.md`
