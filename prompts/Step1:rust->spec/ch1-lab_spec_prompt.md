# Spec 生成 Prompt: ch1-lab

## 角色
你是资深 Rust/OS 工程师与规格工程师。

## 任务
为 crate `ch1-lab` 生成 OpenSpec capability specs。

## 输入文件
请阅读以下文件（在项目根目录下）：
- `ch1-lab/Cargo.toml`
- `ch1-lab/src/**/*.rs`
- `ch1-lab/build.rs`（如果存在）
- `ch1-lab/README.md`（如果存在）
...
1. 创建 `openspec/specs/ch1-lab/spec.md`，包含：
   - 使用 SHALL/MUST 规范化措辞
...
2. 如果 crate 有明显架构/unsafe 约束/feature matrix，创建 `openspec/specs/ch1-lab/design.md`
